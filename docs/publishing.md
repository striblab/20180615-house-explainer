...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20180609-house-explainer">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/20180609-house-explainer/styles.bundle.css`
      * `scripts`: `news/projects/all/20180609-house-explainer/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180609-house-explainer/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180609-house-explainer/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180609-house-explainer/",
      "url": "http://static.startribune.com/news/projects/all/20180609-house-explainer/"
    }
  }
}
```
